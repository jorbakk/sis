...
struct NVGcolor {
  union {
    /// 2025-06-19, jorbakk: swapped the next two rows to enable similar initialization of
    /// theme colors like in the original blendish.h
...
/// Inserted by jorbakk, 2025-03-17
struct NVGtextRow {
